...
const HelpPage = () => {
  return (
    ...
    >
      ...
      <p>To report an issue, go to the 'Report' page, select the type of issue you are reporting, and provide a brief description and location. You can also add a photo of the issue if you wish.</p>
